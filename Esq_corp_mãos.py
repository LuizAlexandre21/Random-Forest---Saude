...
############### Bagging
#bc=BaggingClassifier(base_estimator=dt,n_estimator=10,n_jobs=-1)
...
dt.fit(X_train,y_train)
export_graphviz(dt.estimators_[9], out_file='tree_nonlimited.dot', 
